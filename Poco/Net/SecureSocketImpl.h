...
#ifdef WITH_SEC_VALIDATION
	void check_if_url_is_allowed(const SocketAddress& address);
	/// check if url of host is allowed.
	///
	/// If url is not allowed  then function throws an exception SSLException("Host <hostAddress> is temporarily blocked.")
#endif
